...
C {devices/code.sym} -1076.41357421875 194.92919921875 0 0 {name=NGSPICE
only_toplevel=true
value="
...
"}
C {devices/code_shown.sym} -1070 -60 0 0 {name=s3 only_toplevel=false value="

* Models for standard digital cells

.include ~/conda-gf180mcu-env/envs/gf180mcu-env/share/pdk/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/spice/gf180mcu_fd_sc_mcu7t5v0.spice


* Spice netlist for state machine generated by openlane
.include ~/Sar_ADC_12bit/Schematic/state_machine/openlane/runs/gf_run5/results/signoff/state_machine.spice
